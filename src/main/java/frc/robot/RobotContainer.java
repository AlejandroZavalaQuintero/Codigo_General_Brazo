...
public class RobotContainer {
  ...
  public RobotContainer() {
    chasis.setDefaultCommand(new Cmd_ManualDriveChasis(chasis, () -> ChasisControl.getRightTriggerAxis(),
        () -> ChasisControl.getLeftTriggerAxis(), () -> ChasisControl.getLeftX(),
        () -> ChasisControl.b().getAsBoolean()));
    intake.setDefaultCommand(new Cmd_Intake(intake, () -> SubsystemControl.getLeftY(), 0));
    arm.setDefaultCommand(new Cmd_ManualArm(arm, () -> SubsystemControl.getRightTriggerAxis(),
        () -> SubsystemControl.getLeftTriggerAxis(), () -> SubsystemControl.getRightY(),
        () -> SubsystemControl.y().getAsBoolean()));
  ...
  private void configureBindings() {
    ...
    SubsystemControl.a().whileTrue(new Cmd_MoveArm(arm, 0.25));
